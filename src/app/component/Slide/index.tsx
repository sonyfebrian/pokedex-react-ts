...
import { ReactComponent as LeftArrowIcon } from "app/assets/icon-arrow-left.svg";
import { ReactComponent as RightArrowIcon } from "app/assets/icon-arrow-right.svg";
